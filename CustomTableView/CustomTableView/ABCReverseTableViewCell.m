//
//  ABCReverseTableViewCell.m
//  CustomTableView
//
//  Created by Gagik on 13/06/2019.
//  Copyright © 2019 Gagik Avetisyan. All rights reserved.
//

#import "ABCReverseTableViewCell.h"

@interface ABCReverseTableViewCell ()
...
@implementation ABCReverseTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        @[
          [_coverImageView.trailingAnchor constraintEqualToAnchor:self.contentView.trailingAnchor constant:-10.f],
          ...
          [_titleLabel.trailingAnchor constraintEqualToAnchor:_coverImageView.leadingAnchor constant:-10.f],
          ...
          [_titleLabel.leadingAnchor constraintEqualToAnchor:self.contentView.leadingAnchor constant:10.f],
