...
{
    NSString *APIKey = @"0f08fe534b6c22e567bd75ab8246a5ab";
    return [NSString stringWithFormat:@"https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=%@&tags=%@&per_page=25&page=%ld&format=json&nojsoncallback=1", APIKey, searchString, page];
}
